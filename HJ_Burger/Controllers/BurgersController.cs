...
using HJ_Burger.Data;
using HJ_Burger.Models;

namespace HJ_Burger.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HJ_BurgerContext _context;

        public BurgersController(HJ_BurgerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'HJ_BurgerContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HJ_BurgerContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
